...
LEMMA = Lookup("orm_lexicon.txt", Tex/Mor/Lem, Glo/Cit/Nat)
...
NOUN_PLURAL = NULL | \
		RemoveFinalVowel + Tex/Mor("oota") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("ota") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + TTexMor("toota") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + TTexMor("tota") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("wan") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("wwan") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("een") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("an") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("aan") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + LengthenCons + Tex/Mor("een") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + LengthenCons + Tex/Mor("an") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + LengthenCons + Tex/Mor("aan") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("lee") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("yyii") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("ootii") + Glo("PL") + Nat("more than one (.*)") | \
		RemoveFinalVowel + Tex/Mor("olii") + Glo("PL") + Nat("more than one (.*)")
		

NOUN_DEF = NULL | \
		RemoveFinalVowel + Tex/Mor("icha") + Glo("M.DEF") + Nat("the (.*)") | \
		RemoveFinalVowel + TTexMor("ticha") + Glo("M.DEF") + Nat("the (.*)") | \
		RemoveFinalVowel + Tex/Mor("ittii") + Glo("F.DEF") + Nat("the (.*)") | \
		RemoveFinalVowel + TTexMor("tittii") + Glo("F.DEF") + Nat("the (.*)")
...
NOUN_CASE = NULL | \
		...
		RemoveFinalVowel + After("%s%s" % (V,C), Tex) + NTexMor("nii") + Glo("M.NOM") | \
		RemoveFinalVowel + After("%s" % C, Tex) + TTexMor("ti") + Glo("F.NOM") | \
		RemoveFinalVowel + After("%s" % C, Tex) + TTexMor("tii") + Glo("F.NOM") | \
		RemoveFinalVowel + After("%s" % C, Tex) + Tex/Mor("i") + Glo("NOM") | \
		RemoveFinalVowel + After("%s" % C, Tex) + Tex/Mor("ii") + Glo("NOM") | \
		After(C, Tex) + Glo("NOM") | \
		LengthenGlo("GEN") + Nat("of (.*)")| \
		After(VV) + Mor("GEN") + Nat("of (.*)") | \
		After(C) + Tex/Mor("ii") + Glo("GEN") + Nat("of (.*)") | \
		LengthenGlo("DAT") + Nat("to (.*)") | \
...
NOUN = NOUN_STEM + NOUN_PLURAL + NOUN_DEF + LENGTHENER + ONLY + EMPHASIS + NOUN_CASE + EMPHASIS + EVEN + COORD + MYSTERY
