...
gazetteer = open("/home/data/LoReHLT17/internal/Morph/Orm/v3/orm_gaz.txt", "r")
...
LEMMA = Lookup(("/home/data/LoReHLT17/internal/Morph/Orm/v3/orm_lexicon.txt", "/home/data/LoReHLT17/internal/Morph/Orm/v3/orm_lexicon_wikibooks.txt"), Tex/Mor/Lem, Glo/Cit/Nat)
...
VERB_STEM = LEMMA + Truncate("uu", Tex) | LEMMA + Truncate("chuu", Tex) + Tex/Mor("dh") | LEMMA + Truncate("chuu", Tex) + Tex/Mor("t")
