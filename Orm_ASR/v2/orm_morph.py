    ...
    for dict_filename in dict_filenames:
    	with open(dict_filename, "r", encoding="utf-8") as fin:
        	for line in fin.readlines():
            		...
            		#ipa = g2p(word)
            		#ipa = word     
	    		l1_to_l2[word].append((word,definition))
	    		unVoweled = stripFinalVowel(word)
	    		if unVoweled != word:
...
gazetteer = open("/home/data/LoReHLT17/internal/Morph/Orm/v2/orm_gaz.txt", "r")
...
LEMMA = Lookup(("/home/data/LoReHLT17/internal/Morph/Orm/v2/orm_lexicon.txt", "/home/data/LoReHLT17/internal/Morph/Orm/v2/orm_lexicon_wikibooks.txt"), Tex/Mor/Lem, Glo/Cit/Nat)
...
NOUN_PLURAL = NULL | \
		 Tex/Mor("oota") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("ota") + Glo("PL") + Nat("more than one (.*)") | \
		 TTexMor("toota") + Glo("PL") + Nat("more than one (.*)") | \
		 TTexMor("tota") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("wan") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("wwan") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("een") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("an") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("aan") + Glo("PL") + Nat("more than one (.*)") | \
		 LengthenCons + Tex/Mor("een") + Glo("PL") + Nat("more than one (.*)") | \
		 LengthenCons + Tex/Mor("an") + Glo("PL") + Nat("more than one (.*)") | \
		 LengthenCons + Tex/Mor("aan") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("lee") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("yyii") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("ootii") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("olii") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("oot") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("ot") + Glo("PL") + Nat("more than one (.*)") | \
		 TTexMor("toot") + Glo("PL") + Nat("more than one (.*)") | \
		 TTexMor("tot") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("l") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("yy") + Glo("PL") + Nat("more than one (.*)") | \
		 Tex/Mor("oot") + Glo("PL") + Nat("more than one (.*)") | \
...
NOUN_DEF = NULL | \
		 ...
		 Tex/Mor("ittii") + Glo("F.DEF") + Nat("the (.*)") | \
		 TTexMor("tittii") + Glo("F.DEF") + Nat("the (.*)") | \
		 Tex/Mor("ich") + Glo("M.DEF") + Nat("the (.*)") | \
		 TTexMor("tich") + Glo("M.DEF") + Nat("the (.*)") | \
		 Tex/Mor("itt") + Glo("F.DEF") + Nat("the (.*)") | \
		 TTexMor("titt") + Glo("F.DEF") + Nat("the (.*)")

# -in might be a nominative case marker too
NOUN_CASE = NULL | \
		After(VV, Tex) + Tex/Mor("n") + Glo("NOM") | \
		After("%s%s" % (V,C), Tex) + NTexMor("ni") + Glo("M.NOM") | \
		After("%s%s" % (V,C), Tex) + NTexMor("nii") + Glo("M.NOM") | \
		After("%s" % C, Tex) + TTexMor("ti") + Glo("F.NOM") | \
		After("%s" % C, Tex) + TTexMor("tii") + Glo("F.NOM") | \
		After("%s" % C, Tex) + Tex/Mor("i") + Glo("NOM") | \
		After("%s" % C, Tex) + Tex/Mor("ii") + Glo("NOM") | \
		LengthenGlo("GEN/DAT/ABL") + Nat("of/to/from (.*)")| \
		After(C) + Tex/Mor("ii") + Glo("GEN") + Nat("of (.*)") | \
		Tex/Mor("f") + Glo("DAT") + Nat("to (.*)") | \
		Lengthen + Tex/Mor("f") + Glo("DAT") + Nat("to (.*)") | \
		After(C) + Tex/Mor("iif") + Glo("DAT") + Nat("to (.*)") | \
		After(VV) + Tex/Mor("dhaa") + Glo("DAT") + Nat("to (.*)") | \
		After(VV) + Tex/Mor("dhaaf") + Glo("DAT") + Nat("to (.*)") | \
		TTexMor("tti") + Glo("DAT") + Nat("to (.*)") | \
		After(VV) + Tex/Mor("n") + Glo("INST") + Nat("with (.*)") | \
		Lengthen + Tex/Mor("n") + Glo("INST") + Nat("with (.*)") | \
		After(C) + Tex/Mor("iin") + Glo("INST") + Nat("with (.*)") | \
		After(V) + Tex/Mor("tiin") + Glo("INST") + Nat("with (.*)") | \
		Lengthen + Tex/Mor("tiin") + Glo("INST") + Nat("with (.*)") | \
		After(VV) + Tex/Mor("dhaan") + Glo("INST") + Nat("with (.*)") | \
		TTexMor("tti") + Glo("LOC") + Nat("in (.*)") | \
		TTexMor("ti") + Glo("LOC") + Nat("in (.*)") | \
		After(VV) + Tex/Mor("dhaa") + Glo("ABL") + Nat("from (.*)") | \
		After(C) + Tex/Mor("ii") + Glo("ABL") + Nat("from (.*)") | \
		TTexMor("tii") + Glo("ABL") + Nat("from (.*)") | \
		After(VV, Tex) + Tex/Mor("n") + Glo("NOM") | \
		After("%s%s" % (V,C), Tex) + NTexMor("n") + Glo("M.NOM") | \
		After("%s" % C, Tex) + TTexMor("t") + Glo("F.NOM") | \
		After(VV) + Tex/Mor("dh") + Glo("DAT") + Nat("to (.*)") | \
		TTexMor("tt") + Glo("DAT") + Nat("to (.*)") | \
		TTexMor("tt") + Glo("LOC") + Nat("in (.*)") | \
		TTexMor("t") + Glo("LOC") + Nat("in (.*)") | \
		After(VV) + Tex/Mor("dh") + Glo("ABL") + Nat("from (.*)") | \
		TTexMor("t") + Glo("ABL") + Nat("from (.*)")	
		
LENGTHENER = NULL | TTexMor("ti") + Glo("LENG") | TTexMor("tii") + Glo("LENG")

EMPHASIS = NULL | \
		LengthenGlo("EMPH") | \
		Lengthen + Tex/Mor("tuu") + Glo("EMPH") | \
		Tex/Mor("tuu") + Glo("EMPH")

ONLY = NULL |  Tex/Mor("uma") + Glo("ONLY") + Nat("only (.*)")

EVEN = NULL | Tex/Mor("llee") + Glo("EVEN") + Nat("even (.*)")

COORD = NULL | \
	Tex/Mor("f") + Glo("AND") + Nat("and (.*)") | \
	Tex/Mor("fi") + Glo("AND") + Nat("and (.*)") | \
	Lengthen + Tex/Mor("s") + Glo("AS_WELL") + Nat("as well as (.*)") | \
	Tex/Mor("s") + Glo("AS_WELL") + Nat("as well as (.*)")

MYSTERY = NULL | \
		Tex/Mor("faa") + Glo("UNKNOWN")
...
VERB_STEM = LEMMA + Truncate("uu", Tex)
...
ASP_AGR = Tex/Mor("e") + Glo("1SG.PST.AFF") + Nat("I did (.*)") | \
		...
		Tex/Mor("a") + Glo("PRS.AFF") + Nat("he (.*)") | \
		VOWEL_EPENTHESIS + TTexMor("ti") + Glo("3SGF.PRS.AFF") + Nat("she (.*)") | \
		...
		Tex/Mor("u") + Glo("PRS.AFF") + Nat("he (.*)") | \
		VOWEL_EPENTHESIS + TTexMor("tu") + Glo("3SGF.PRS.AFF") + Nat("she (.*)") | \
		...
		Tex/Mor("aa") + Glo("2PL.JUSS.AFF") + Nat("you-pl, (.*)!") | \
		Tex/Mor("anu") + Glo("3PL.JUSS.AFF") + Nat("let them (.*)!") | \
		Tex/Mor("iin") + Glo("2SG.JUSS.NEG") + Nat("you-sg, don't (.*)!") | \
		Tex/Mor("in") + Glo("JUSS.NEG") + Nat("let him not (.*)!") | \
		Tex/Mor("inaa") + Glo("2PL.JUSS.NEG") + Nat("you-pl, don't (.*)!") | \
		Tex/Mor("iinaa") + Glo("2PL.JUSS.NEG") + Nat("you-pl, don't (.*)!")
		


INFINITIVE = NULL | \
		Tex/Mor("uu") + Glo("INF") + Nat("to (.*)")
